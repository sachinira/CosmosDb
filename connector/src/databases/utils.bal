...
public function setHeaders(http:Request req, string apiversion, string host, string verb, string resourceType, string resourceId,
                                     string keyToken, string tokenType, string tokenVersion) returns http:Request|error{
