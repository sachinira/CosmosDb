...
function test_createContainer(){
    ...
    var result = database->createContainer(propertiesNewCollection, pk);
...
function test_createContainerIfNotExist(){
    ...
    var result = database->createContainerIfNotExist(propertiesNewCollectionIfNotExist, pk);
    if (result is Container?) {
        io:println(result);
    } else {
        test:assertFail(msg = result.message());
...
function test_getOneContainer(){
    ...
    var result = database->getContainer(getCollection);
    if result is error {
        test:assertFail(msg = result.message());
    } else {
        var output = "";
...
function test_deleteContainer(){
    ...
    var result = database->deleteContainer(deleteCollectionData);
    if result is error {
        test:assertFail(msg = result.message());
    } else {
        var output = "";
...
function test_GetPartitionKeyRanges(){
    ...
    var result = container->getPartitionKeyRanges(resourceProperties);
    if result is error {
        test:assertFail(msg = result.message());
    } else {
        var output = "";
...
function test_getDocumentList(){
    ...
    var result = container->getDocumentList(resourceProperty);
    if result is error {
        test:assertFail(msg = result.message());
    } else {
        var output = "";
...
function test_GetOneDocument(){
    ...
    var result = container->getDocument(resourceProperty, getDoc);
    if result is error {
        test:assertFail(msg = result.message());
    } else {
        var output = "";
...
function test_deleteDocument(){
    ...
    var result = container->deleteDocument(resourceProperty, deleteDoc);  
    if result is error {
        test:assertFail(msg = result.message());
    } else {
        var output = "";
...
function test_queryDocuments(){
    ...
    var result = container->queryDocuments(resourceProperty, partitionKey, sqlQuery);   
    if result is error {
        test:assertFail(msg = result.message());
    } else {
        var output = "";
...
function test_replaceStoredProcedure(){
    ...
    var result = container->replaceStoredProcedure(resourceProperty, sp);  
    if result is error {
        test:assertFail(msg = result.message());
    } else {
        var output = "";
...
function test_getAllStoredProcedures(){
    ...
    var result = container->listStoredProcedures(resourceProperty);   
    if result is error {
        test:assertFail(msg = result.message());
    } else {
        var output = "";
...
function test_executeOneStoredProcedure(){
    ...
    var result = container->executeStoredProcedure(resourceProperty, executeSprocId, arrayofparameters);   
    if result is error {
        test:assertFail(msg = result.message());
    } else {
        var output = "";
...
function test_deleteOneStoredProcedure(){
    ...
    var result = container->deleteStoredProcedure(resourceProperty, deleteSprocId);   
    if result is error {
        test:assertFail(msg = result.message());
    } else {
        var output = "";
...
function test_replaceUDF(){
    ...
    var result = container->replaceUserDefinedFunction(resourceProperty, replacementUdf);  
    if result is error {
        test:assertFail(msg = result.message());
    } else {
        var output = "";
...
function test_listAllUDF(){
    ...
    var result = container->listUserDefinedFunctions(resourceProperty);  
    if result is error {
        test:assertFail(msg = result.message());
    } else {
        var output = "";
...
function test_deleteUDF(){
    ...
    var result = container->deleteUserDefinedFunction(resourceProperty, deleteUDFId);  
    if result is error {
        test:assertFail(msg = result.message());
    } else {
        var output = "";
...
function test_replaceTrigger(){
    ...
    var result = container->replaceTrigger(resourceProperty, replaceTrigger);  
    if result is error {
        test:assertFail(msg = result.message());
    } else {
        var output = "";
...
function test_listTriggers(){
    ...
    var result = container->listTriggers(resourceProperty);  
    if result is error {
        test:assertFail(msg = result.message());
    } else {
        var output = "";
...
function test_deleteTrigger(){
    ...
    var result = container->deleteTrigger(resourceProperty, deleteTriggerId);  
    if result is error {
        test:assertFail(msg = result.message());
    } else {
        var output = "";
...
function test_getCollection_Resource_Token(){
    ...
    if result is error {
        ...
        if result?._token is string {
            ...
            Database AzureCosmosClientDatabase = new(configdb);
